...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/png" href="{{ asset('userstyle/images/favicon.png') }}">
	<!-- Web Font -->
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="{{ route('website.index') }}"><img src="{{ asset('userstyle/images/logo.png') }}" alt="logo"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li>
                                            ...
                                            <form class="d-inline" method="POST" action="{{ route('website.remove_item', $item->id) }}">
                                                @csrf
                                                @method('delete')
                                                <button class="btn btn-sm p-0"><i class="fa fa-remove"></i></button></form>
											<a class="cart-img" href="#"><img src="{{ asset('images/'. $item->product->image) }}" alt="#"></a>
											<h4><a href="#">{{ $item->product->name }}</a></h4>
											<p class="quantity"><span class="amount">${{ $item->product->price }}</span></p>
                                            @php
							...
							<div class="all-category">
								...
								<ul class="main-category">
                                    @foreach (Category::all() as $item)
                                        <li><a href="{{ route('website.category', $item->slug) }}">{{ $item->name }}</a></li>
                                    @endforeach
								</ul>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="index.html"><img src="{{ asset('userstyle/images/logo2.png') }}" alt="#"></a>
							</div>
			...
			<div class="container">
				<div class="inner">
					<div class="row">
						...
						<div class="col-lg-6 col-12">
							<div class="right">
								<img src="{{ asset('userstyle/images/payments.png') }}" alt="#">
							</div>
						</div>
					</div>
				</div>
